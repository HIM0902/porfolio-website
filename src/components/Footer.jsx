    ...
    <footer className="footer section">
      <div className="glass-card footer-card">
        ...
        <div className="footer-cta">
          <a href="mailto:quintanaj0215@gmail.com" className="btn btn-primary btn-large">Get In Touch</a>
        </div>
        ...
        <div className="social-links">
          ...
          {/* Footer Resume Download Link */}
          <a href="/John_Quintana_Resume.pdf" target="_blank" rel="noreferrer" aria-label="Resume" download>
